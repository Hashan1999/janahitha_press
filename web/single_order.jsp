...
<div class="x_panel">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Order Items<small>search,update,print Orders from here</small></h2>
...
<tr id="orderItemTable<%= item.getIdorderItem() %>">
                          <td><%= item.getIdorderItem() %></td>
                          <td><%= item.getSellingItems().getName() %></td>
                          <td><%= item.getUnitPrice() %></td>
                          <td><%= item.getQty() %></td>
                          <td><%= item.getOrderItemDescription() %></td>
                          <td><%= item.getQty()*item.getUnitPrice() %></td>
                        
                       
                          <td><button onclick="removeOrder(<%= item.getIdorderItem() %>);" class="btn btn-dark">Remove</button></td>
                        </tr>
