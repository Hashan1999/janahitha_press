                                ...
                                <div class="x_content">
                                    ...
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" >
                                        ...
                                        <%
                                            ...
                                            c.add(Restrictions.eq("idrawItem", id));

                                            Criteria c2 = s2.createCriteria(Brand.class);
                                            List<Brand> sList = (List<Brand>) c2.list();
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" name="name" id="name2" required="required" class="form-control " value="<%= ri.getName()%>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="description2" name="description" required="required" class="form-control" value="<%= ri.getDescription()%>">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 " id="brands">
                                                <select id="selectBrand" class="form-control" required>
                                                    ...
                                                    <%
                                                        ...
                                                        for (Brand s : sList) {
                                                            if(s.getName()==ri.getBrand().getName()){
                                        ...
                                        <div class="item form-group">
                                            <div class="col-md-6 col-sm-6 offset-md-3">
                                                ...
                                                <button type="button" class="btn btn-success" onclick="rowItemUpdate(<%= ri.getIdrawItem() %>)">Update</button>
