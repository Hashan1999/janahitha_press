...
<html lang="en">
  <head>
    ...
    <title> Janahitha Printers | Delivery Notes</title>
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <div class="clearfix"></div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>All Delivery Notes<small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="order-datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody id="customer_table_body">
                       ...
                       List<Delivery> delivery=(List<Delivery>)hibernateSession.createCriteria(Delivery.class).add(Restrictions.eq("order", o)).list();
for (Delivery item : delivery) {
                       
%>

<tr id="customerTable<%= item.getIddeliveryNote() %>">
                          <td><%= item.getIddeliveryNote() %></td>
                          <td><%= item.getDescription() %></td>
                         <td><%= new SimpleDateFormat("YYYY-MM-dd").format(item.getDate()) %></td>
                          <td><%= item.getDeliveryStatus().getStatus() %></td>
                          
                          <td><a href="single_delivery_note.jsp?id=<%= item.getIddeliveryNote() %>"><button class="btn btn-dark">View</button></a></td>
                        </tr>
