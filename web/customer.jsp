...
<html lang="en">
  <head>
    ...
    <title> Janahitha Printers | Customers</title>
          ...
          <div class="">
            ...
            <div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Customer Registration <small>register your new customer here</small></h2>
								...
								<div class="x_content">
									<br>
                                                                        <form id="demo-form2" onsubmit="registerCustomer();return false" data-parsley-validate class="form-horizontal form-label-left" >
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
                                                                                            <input required="" type="text" id="last-name" name="last-name" class="form-control">
											</div>
										</div>
										<div class="item form-group">
											<label for="contact" class="col-form-label col-md-3 col-sm-3 label-align">Contact Number</label>
											<div class="col-md-6 col-sm-6 ">
                                                                                            <input required="" id="contact" class="form-control"  type="tel" name="contact">
											</div>
										</div>
										<div class="item form-group">
											<label for="description" class="col-form-label col-md-3 col-sm-3 label-align">Description</label>
											<div class="col-md-6 col-sm-6 ">
												<textarea id="description"  class="form-control" name="description" data-parsley-trigger="keyup" ></textarea>
											</div>
										</div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>All Customers<small>search,update,print customers from here</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
                  ...
                  <div class="x_content">
                    ...
                    <table id="customer-datatable" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>ID</th>
                          <th>First Name</th>
                      ...
                      <tbody id="customer_table_body">
                       ...
                       List<Customer> customerList=(List<Customer>)hibernateSession.createCriteria(Customer.class).list();
for (Customer customer : customerList) {
                       
%>

<tr id="customerTable<%= customer.getIdcustomer() %>">
                          <td><%= customer.getIdcustomer() %></td>
                          <td><%= customer.getFirstName() %></td>
                          <td><%= customer.getLastName() %></td>
                          <td><%= customer.getContact() %></td>
                          <td><%= customer.getDescription() %></td>
                          <td><button onclick="dispatchUpdateForm(<%= customer.getIdcustomer() %>);" class="btn btn-dark">Update</button></td>
                        </tr>
