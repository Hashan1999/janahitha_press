...
<html lang="en">
  <head>
    ...
    <title> Janahitha Printers | Orders</title>
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <div class="clearfix"></div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>All Orders<small>search,update,print Orders from here</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="order-datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody id="customer_table_body">
                       ...
                       List<Order> orders=(List<Order>)hibernateSession.createCriteria(Order.class).list();
for (Order item : orders) {
                       
%>

<tr id="customerTable<%= item.getIdorder() %>">
                          <td><%= item.getIdorder() %></td>
                          <td><%= item.getCustomer().getFirstName()+" "+item.getCustomer().getLastName() %></td>
                          <td><%= item.getCustomer().getContact() %></td>
                          <td><%= new SimpleDateFormat("YYYY-MM-dd").format(item.getDate()) %></td>
                          <td><%= item.getDescription() %></td>
                          <td><%= item.getUniqueIdentifierText() %></td>
                          <td><%= new SimpleDateFormat("YYYY-MM-dd").format(item.getDeliverDate()) %></td>
                          <td><%= item.getDueAmount() %></td>
                          <td><%= item.getOrderStatus().getStatus() %></td>
                       
                          <td><a href="single_order.jsp?id=<%= item.getIdorder() %>"><button class="btn btn-dark">View</button></a></td>
                        </tr>
