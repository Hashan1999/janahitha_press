 ...
 */
public class Save_job extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (customer.isEmpty()) {
                ...
                validation = false;
                responce = "Need a Order To register print job";
                        ...
                        if (orderObj != null) {
                            ...
                            if (machineObj != null) {
                                ...
                                if (validation) {
                                    ...
                                    session.save(printingJob);

                                    PlateHasPrintingJob plateHasPrintingJob = new PlateHasPrintingJob(plateObj, printingJob);
                                    session.save(plateHasPrintingJob);
